class PrinterConfig {
  ...
  PrinterConfig({
    ...
    this.footerMessage = 'Thank you for visiting Aroma Tea Cafe! Have a blissful day ☕',
  ...
  factory PrinterConfig.fromJson(Map<String, dynamic> json) {
    return PrinterConfig(
      ...
      cafeName: (json['cafeName'] ?? 'AROMA TEA CAFE').toString(),
      ...
      footerMessage: (json['footerMessage'] ?? 'Thank you for visiting Aroma Tea Cafe!').toString(),
      taxPercentage: double.tryParse((json['taxPercentage'] ?? '5.0').toString()) ?? 5.0,
